...
class Reports_model extends CI_Model{
    ...
    public function daily_entry_report($params){
        ...
        initcap(a.design)design, initcap(b.division)division, UPPER(a.prepby)prepby, initcap(a.remarks)remarks, a.imgname, case when a.imgname is not null then 'http://erp.crgarments.com:8082/axpattach/CR/empunifhel/'||imgname else null end imgurl from uniftrackmast a, div_mast b
    ...
    public function emp_entry_report($params){
        ...
        initcap(a.design)design, initcap(b.division)division, UPPER(a.prepby)prepby, initcap(a.remarks)remarks, a.imgname, case when a.imgname is not null then 'https://erp.crgarments.com:8443/axpattach/CR/empunifhel/'||imgname else null end imgurl from uniftrackmast a, div_mast b
